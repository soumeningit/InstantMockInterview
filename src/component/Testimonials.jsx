          ...
          <Slider {...settings} className="mt-8 md:mt-12 lg:mt-16">
            {testimonials.map((testimonial) => (
              <div key={testimonial.id} className="p-2 sm:p-4">
                <div className="flex flex-col overflow-hidden shadow-lg rounded-lg bg-white p-6 sm:p-8 h-[18.6rem] w-full max-w-[20rem] mx-auto">
                  <img
                  ...
                  <div className="text-center">
                    <h3 className="font-semibold sm:font-bold text-base sm:text-lg text-sky-950">
                      {testimonial.name}
                    </h3>
