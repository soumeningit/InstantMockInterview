...
function SignUpPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-screen p-6 bg-opacity-20 backdrop-blur-xl rounded-xl shadow-lg border border-white border-opacity-30">
      <h1 className="text-3xl font-bold text-sky-700 mb-6">Sign Up</h1>
      <form
