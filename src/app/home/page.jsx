    ...
    <>
      <div className="p-4 flex flex-col bg-white">
        <div className="p-4 mt-10 flex flex-col items-center justify-center gap-7">
          ...
          <button
            onClick={handleGetStarted}
            className="px-6 py-2 mt-5 bg-gradient-to-r from-blue-400 via-teal-500 to-purple-600 rounded-full hover:scale-105 transition duration-300 ease-out"
            aria-label="Get Started"
          >
            <span className="flex items-center text-zinc-200 space-x-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
            ...
            <div className="text-base text-green-400 mt-4">
              ...
              <div className="flex w-full items-start gap-4 mt-5">
                ...
                <div className="flex -space-x-4">
                  {[
                    "https://storage.googleapis.com/assets-aiapply/monika-profile-pic.jpg",
                    "https://storage.googleapis.com/assets-aiapply/woman-social-proof.webp",
                    "https://storage.googleapis.com/assets-aiapply/woman-social-proof2.webp",
                    "https://storage.googleapis.com/assets-aiapply/man-social-proof.webp",
                  ].map((src, idx) => (
                    <div
                      key={idx}
                      className="rounded-full border-2 border-white w-10 h-10 transition hover:scale-110"
                    >
                      <img
                        src={src}
                        alt="Social Proof"
                ...
                <div className="flex flex-col ml-4 text-orange-400">
                  <div>★★★★★</div>
                  <div className="text-xs text-gray-500">
                    Loved by 325,114 users
                  </div>
                </div>
              </div>
            </div>
            <div className="p-5 mt-5 space-y-7">
              ...
              <p className="text-lg font-semibold text-zinc-600">
                Practice your domain-related interview questions, get feedback,
          ...
          {/* Right Side */}
          <div className="p-4 bg-white shadow-md border border-gray-200 rounded-lg mt-10 flex flex-col">
            <span className="text-lg text-gray-800 mb-4">
              Turn a job description into interview questions to practice with
            </span>
            <div className="flex flex-wrap gap-2 mb-4">
              {jobDescriptions.map((data, index) => (
                <div
                  key={index}
                  className="px-4 py-1 bg-gray-400 text-zinc-700 rounded-full cursor-pointer hover:bg-teal-200 hover:text-zinc-900 hover:scale-110 transition ease-out duration-300"
                >
                  {data.title}
                </div>
              ))}
            </div>
            <div className="h-64 p-5 mt-7 rounded-lg border border-gray-200">
              <img
                src="./hero_1.jpg"
                alt="Hero"
                loading="lazy"
        ...
        {/* Testimonials, How to Proceed, and FAQ */}
